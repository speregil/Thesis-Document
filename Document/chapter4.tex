...
section \ref{sec:5-1}, as well in the general structure of the process shown in this chapter, but overall, the approach to implementation changed substantially.
...
as can be seen on section \ref{sec:6-4-1}. Some other aspects of the functionality of \emph{WorkshopAR} that were refined by comparing the architectural proposal with
