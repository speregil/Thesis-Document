...
Within the context of the Industry Project course (also refered in this document as ENBU79X/89X), the objective is to analyse how students use \ac{AR} technologies as an aid for the collaborative aspects of their
...
The Industry Project course focuses on developing crucial soft skills on students in the context of project development and management, emulating in different ways common
processes and scenarios found on the construction industry. In general, the learning goals can be enunciated as:
...
The expected learning outcomes of the course highlight teamwork and communication, and as such, the intervention designed around \emph{WorkshopAR} should
...
The main goal can also be aligned to research questions SQ1 through SQ3. The case study around the course provides an ideal observation environment to compare different
...
described in Chapter \ref{ch5}, and a description of the changes and adaptations needed to properly incorporate \emph{WorkshopAR} as part of the observed cohort can be found in
Chapter \ref{ch6}.
